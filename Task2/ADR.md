...
1. Новую логику (учет ставок, процесс согласование, отправку смс) выносим в отдельным сервис АБС Backend. Дальнейшую разработку процедур в БД считаем нецелесообразной.
2. логику на PL-SQL процедурах оставляем, но в следующих итерациях будем от нее избавляться.
3. 
